...
`--redact` ne modifie jamais ce format ni le contenu déjà stocké. Il agit uniquement sur une copie envoyée à un reporter pour faciliter le partage d’un rapport.
